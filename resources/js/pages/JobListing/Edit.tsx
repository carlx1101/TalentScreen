...
import { type BreadcrumbItem, type JobListing } from '@/types';
...
export default function EditJobListing({ jobListing, skills, employmentBenefits }: Props) {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
      ...
      href: `/job-listings/${jobListing.id}/edit`,
    },
  ];

  const { data, setData, put, processing, errors } = useForm<EditJobListingData>({
    title: jobListing.title || '',
    description: jobListing.description || '',
    employment_type: jobListing.employment_type || '',
    mode: jobListing.mode || [],
    skills: jobListing.skills || [],
    languages: jobListing.languages || [],
    location: jobListing.location || '',
    salary_currency: jobListing.salary_currency || '',
    salary_min: jobListing.salary_min ? jobListing.salary_min.toString() : '',
    salary_max: jobListing.salary_max ? jobListing.salary_max.toString() : '',
  ...
  const handleSubmit = () => {
    put(`/job-listings/${jobListing.id}`, {
      onSuccess: () => {
      ...
      <div className="p-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update the job listing information for your company.
            </CardDescription>
          </CardHeader>
          <CardContent>
